...
| 날짜 | 작업 | workthrough |
|------|------|-------------|
| 2026-08-24 | Telegram tap-to-build Word Order 12문항: stable shuffle·Redis draft·undo/reset/submit·exact grading (ADR-043) | `2608/2608241307_word_order_telegram_mvp.md` |
